...
public class AddCardModel implements IAddCard{
private Handler handler = new Handler(Looper.getMainLooper());
    public void addCard(Map<String,String> params, final OnNetListener<BaseBean> onNetListener){
        OkHttpUtils.getOkHttpUtils().doPost(Api.ADD_CARD, params, new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final BaseBean bean = new Gson().fromJson(string, BaseBean.class);
                handler.post(new Runnable() {
                    @Override
                    public void run() {
